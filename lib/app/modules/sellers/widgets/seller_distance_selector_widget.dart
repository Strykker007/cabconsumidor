...
class SellerDistanceSelectorWidget extends StatefulWidget {
  const SellerDistanceSelectorWidget({super.key});

  @override
  State<SellerDistanceSelectorWidget> createState() =>
      _SellerDistanceSelectorWidgetState();
}

class _SellerDistanceSelectorWidgetState
    extends State<SellerDistanceSelectorWidget> {
